function RHO = runCCAF( FF2, erp2use_cca, template_Synth, epoch, Xnotch, Ynotch,Xharm, Yharm,Xlowpass, Ylowpass, n , EEG)
...
for HH = 1:n.harmonics
    ...
    tmp = filtfilt( Xnotch, Ynotch, double(EEG) ); % notch
    tmp = filtfilt( Xlowpass{HH}, Ylowpass{HH}, tmp );
    trial_harm = filtfilt( Xharm{HH}, Yharm{HH}, tmp );
